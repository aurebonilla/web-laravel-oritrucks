...
<div class="form-container">
    <form action="{{ route('valoracion.store') }}" method="POST">
        @csrf
        <label for="viaje_id">ID del Viaje:</label>
        <input type="text" id="viaje_id" name="viaje_id" required>

        <label for="usuario_dni">DNI del Usuario:</label>
        <input type="text" id="usuario_dni" name="usuario_dni" required>
